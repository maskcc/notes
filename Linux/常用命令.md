...
85. 查看盘符 `lsblk -dno LABEL /dev/sda1`, `blkid -s LABEL -o value /dev/sda2`, 查看 UUID `lsblk -dno UUID /dev/sda1`, `blkid -s UUID -o value /dev/sda1`, 查看分区UUID,`lsblk -dno PARTUUID /dev/sda1`, `blkid -s PARTUUID -o value /dev/sda1`
