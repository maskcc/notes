;(function () {
resProtocol = location.protocol.substr(0, 4) === 'http' ? '' : 'http:';
document.write("<link rel='stylesheet' type='text/css' href='" + resProtocol + "//csdnimg.cn/pubfooter/css/pub_footer_2012.css' />");
...
document.write("</dl>");
document.write("</div>");
document.write('<script id="noticeScript" type="text/javascript"  btnId="header_notice_num" wrapId="note1" count="5" subcount="5" src="' + resProtocol + '//' +


'csdnimg.cn' +

'/rabbit/notev2/js/notify.js?20131118"></script>');

var head = document.getElementsByTagName('head')[0]
	, s, ss = [
		resProtocol + '//csdnimg.cn/pubfooter/js/tracking.js?r1108'
		, resProtocol + '//csdnimg.cn/rabbit/tracking-ad/main.js?r1022'
	]
	;
