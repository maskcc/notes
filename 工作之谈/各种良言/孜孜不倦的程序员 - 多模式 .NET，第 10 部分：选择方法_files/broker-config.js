...
//Array [PATH,SITE_CODE,FREQ]
var _technet = [ ["default.aspx",'1219',0.3],["library",'1192',0.3],["cloud",'2201',0.3],["network",'2200',0.3],["sbs",'2199',0.3],["windowsserver",'1194',0.0924],["forefront",'1011',0.3], ["sharepoint",'1196',0.3],["sqlserver",'1197',0.1303],["systemcenter",'1198',0.3],["windows",'1199',0.0005],["scriptcenter",'1200',0.3],["security",'1202',0.2732],["subscriptions",'1206',0.3],["sysinternals",'1203',0.0924],["ie",'1220',0.3],["exchange",'1221',0.3],["lync",'1566',0.3]  ];
...
function checkWTSP(){
	 ...
	 if(_Site == '1176'){
		...
		if(!(/msdnlib_hp|msdn_library_sqlserver|windowsazure|msdnlib_w32_com|msdnlib_office365|msdnlib_office/i.test(_wtsp))){
			_halt=true;
